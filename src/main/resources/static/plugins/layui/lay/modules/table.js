...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), i.loading(), t.ajax({
                ...
                success: function (t) {
                    ...
                    //         (i.renderForm(), i.errorView(t[n.msgName] || '返回的数据不符合规范，正确的成功状态码应为："' + n.statusName + '": ' + n.statusCode)) :
                    ...
                    //此处重写layui table 状态码校验
                    //因全局已拦截layui ajax请求，全局统一校验状态码，此处不校验状态码

                    "function" == typeof a.parseData &&
                    (t = a.parseData(t) || t), (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof a.done && a.done(t, e, t[n.countName])
                },
                error: function (e, t) {
        ...
        return d.cache[c.key] = y, c.layPage[0 == o || 0 === y.length && 1 == n ? "addClass" : "removeClass"](f), r ? b() : 0 === y.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(f), b(), c.renderTotal(y, h), void (s.page && (s.page = t.extend({
            ...
            count: o,
            limit: s.limit,
            limits: s.limits || [20, 40, 50, 100, 200],
            groups: 3,
